locals {
  thresholds = {
    ...
    PageLifeExpectancyEvaluationPeriods            = min(max(var.page_life_expectancy_evaluation_periods, 1), 10)
    PageLifeExpectancyThreshold                    = min(max(var.page_life_expectancy_threshold, 1), 2000000000)
